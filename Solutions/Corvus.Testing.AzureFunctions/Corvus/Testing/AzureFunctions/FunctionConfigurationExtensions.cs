...
{
    /// <summary>
    /// Copies all the values from the supplied list to function configuration
    ...
    /// finally added nullability annotations). For example, given this:
    /// </para>
    /// <code><![CDATA[
    /// {
    ///   "Root": {
    ...
    /// value. This wasn't obvious until <c>Microsoft.Extensions.Configuration.Abstractions</c> were
    ...
    /// </para>
    /// </remarks>
    public static void CopyToEnvironmentVariables(this FunctionConfiguration functionConfiguration, IEnumerable<KeyValuePair<string, string?>> values)
    {
